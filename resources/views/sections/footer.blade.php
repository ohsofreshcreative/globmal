...
<footer
	class="footer relative overflow-hidden  text-white bg-brand">
	<div class="relative z-10 c-main px-6 ">
		<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 footer-py">
			<div class="flex flex-col gap-3">
				...
				<div class="text-base text-white mb-3 _address border-b border-t border-p-lighter py-3 max-w-[280px]">
					{!! $contact['address'] !!}
				</div>
				@endif
	...
	<div class="footer-bottom border-t border-p-lighter w-full ">
