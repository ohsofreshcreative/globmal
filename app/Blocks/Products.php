...
class Products extends Block
{
	...
	public $keywords = ['products', 'kafelki'];
	public $mode = 'edit';
	public $supports = [
		'align' => false,
		'mode' => true,
	...
	public function fields()
	{
		...
		$products
			...
			->addText('tab', [
				...
				'instructions' => 'Wpisz nazwę zakładki, do której ma trafić ten element (np. "Węglik spiekany"). Elementy o tej samej nazwie zostaną zgrupowane.',
				'required' => 1,
			])
			->addImage('image', [
				'label' => 'Obraz',
	...
	public function with()
	{
		return [
			...
			'r_products' => get_field('r_products'),
